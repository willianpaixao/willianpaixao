...
\item Designed and maintained an observability stack, built dynamic Grafana dashboards, setup alerting rules and integrated Loki for logs \footnote{A complete and detailed list of experiences can be found in my \href{https://www.linkedin.com/in/willianpaixao/details/experience/}{LinkedIn} profile}
\end{tightemize}
% \sectionsep
...
% % \item Evaluated new DevOps tools and frameworks to improve processes, such as CI/CD, orchestration, and monitoring solutions \footnote{A complete and detailed list of experiences can be found in my
% % \end{tightemize}
% % \sectionsep
